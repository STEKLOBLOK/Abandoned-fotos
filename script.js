...
const chapters = [
    // ========== ГЛАВА 1: ПРИБЫТИЕ ==========
    {
        ...
        steps: [
            ...
            {
                id: 15,
                text: `Лицо мужчина каменеет. «Правильно. Забудь, что я спросил». Он резко отворачивается к окну. На следующей остановке выходит, скрывает взгляд.\n\nАвтобус продолжает путь.`,
                choices: [
    ...
    // ========== ГЛАВА 2: АРТЗ. ПЕРВАЯ СМЕНА ==========
    {
        ...
        steps: [
            ...
            {
                id: 1,
                text: `«Прямо, потом налево, первый корпус» — кивает охранник.\n\nКоридоры завода напоминают лабиринт: бетонные стены, трубы под потолком, резкий запах канифоли и кислоты. На стенах — плакаты: «Советское – значит качественное!», «Мой завод – моя гордость!»\n\nВы находите цех №1. Огромное помещение, заставленное столами с паяльными станциями, краном-балкой и станками. Десятки людей в белых халатах, приглушённый гул вентиляции.`,
                choices: [
            ...
            {
                id: 18,
                text: `Вы запоминаете: 15:30, среда, грузовик ЗиЛ-131 с номером 042, северные ворота. Маршрут — между цехов и в темноту кирпичных стен.\n\nРаботаете дальше, делая вид, что ничего не заметили.\n\nСмена заканчивается.`,
                choices: [
            ...
            {
                id: 21,
                text: `ВЕЧЕР. Вы идёте по улице Курчатова к общежитию. Город живёт своей жизнью: дети играют в песочнице, пенсионеры сидят на лавочках, из открытых окон доносится музыка или разговоры.\n\nНо теперь вы видите другое: странные люди в штатском, патрули милиции, закрытые шторы на окнах некоторых квартир.\n\nВ кармане блокнот Кротова жжёт, как уголь. Контроль везде. Свобода - рабство.\n\nВы подходите к общежитию. Первый рабочий день в Атом-5 окончен.`,
                choices: [
                    { text: "ЗАВЕРШИТЬ ГЛАВУ", nextStep: -1, karma: 0, effect: () => { endChapter(); } }
                ]
            }
    ...
    // ========== ГЛАВА 3: РЛК «ОКО-12» ==========
    {
        ...
        steps: [
            ...
            {
                id: 2,
                text: `КПП №1 — уже знакомый солдат с первой главы. «А, Семёнов. В часть? Садитесь» — он указывает на «уазик» с затемнёнными стёклами.\n\nВодитель — угрюмый сержант. Едем молча. Дорога идёт вдоль завода, на север.Потом сквозь поля, простор и вольность. Но... \n\n«ОКО-12» появляется внезапно: гигантские антенны, похожие на скелеты доисторических животных. Радиолокационный комплекс.`,
                choices: [
            ...
            {
                id: 3,
                text: `«Не положено!» — хрипло отвечает сержант. «Больше вопросов не будет?»\n\nМашина останавливается у КПП части. Солдаты с автоматами.`,
                choices: [
            ...
            {
                id: 29,
                text: `Вы бежите через спящий город. Папка Кротова в руках жжёт, как расплавленное радиоактивное топливо. В ней — документы, фотографии, расчёты.\n\n«Объект 17» действительно не земного происхождения. Его породили путём некого эксперимента в 1974-м. Он излучает неизвестный тип энергии, влияет на психику людей и материю. Но самое страшное – это то что эксперимент был не один. "Объект 17". А где предыдущие 16?\n\nИспытания завтра. Если мощность превысит критический уровень, может произойти «разрыв» — что-то вроде локального коллапса реальности.\n\nВы приходите в общежитие. Ночь. Завтра решающий день.\n\nНужно решить: использовать документы, чтобы предупредить Москву? Или действовать самостоятельно?`,
                choices: [
