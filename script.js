...
const chapters = [
    // ========== ГЛАВА 1: ПРИБЫТИЕ ==========
    {
        ...
        steps: [
            {
                id: 0,
                text: `АВТОБУС "ИКАРУС" ГЛУШИТ ДВИГАТЕЛЬ. Сквозь утренний туман прорезаются огни контрольно-пропускного пункта.\n\nВы — ИГОРЬ СЕМЁНОВ, 24 года. Молодой инженер-электронщик, распределённый на АРТЗ после Московского института. В кармане — пропуск с грифом "Совершенно секретно" и пожелтевшее письмо от отца, который работал здесь в 60-х: "Городищево — наш дом. И наша тюйма. Будь осторожен".\n\nСолдат в шинели стучит костяшками пальцев по стеклу. Его лицо не выражает ничего, кроме усталости от ночной смены.`,
                choices: [
